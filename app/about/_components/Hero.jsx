...
lg:items-center justify-center z-0 py-12 md:py-3 lg:py-5 overflow-hidden">
    ...
    <div className="flex relative w-full lg:w-[80vw] justify-between ">
        ...
        <div className="w-[95vw]  lg:w-1/2 flex flex-col justify-center extra-padding gap-y-4 relative left-5 ">
            ...
            <h1 className="text-white text-7xl mt-2 hero-headline font-stretch-ultra-expanded text-left"> 
                We Go Deep 
                <br/> So That You <br/> 
            <span className="tracking-wider font-bold text-transparent headline-outline"> Don&apos;t Have To.</span></h1>
            <p className="serif text-3xl text-light italic text-left ">
                &quot;Like the ocean, compliance has visible currents and invisible depths.
                 Most organisations manage the surface. We go further.&quot;
            </p>
            <p className="text-light text-left  w-[80%] text-sm/8 mons-font ">
            OCEION is a specialist data privacy, information security, and regulatory compliance consultancy — built at the intersection of law, technology, and organisational governance. 
            Founded by practitioners. Trusted by businesses from seed stage to listed enterprise.
    </p>
    <div className="flex flex-col lg:flex-row justify-center items-start md:justify-start md:items-start gap-x-4 gap-y-4 box-border ">
        ...
        shadow-xl hover:bg-mid hover:-translate-y-0.5 leading-normal px-5 uppercase text-sm">Our Story</button>
        ...
        bg-transparent border border-bright text-bright md:w-[30%] lg:h-12.5  cursor-pointer
         hover:bg-light hover:text-white leading-normal w-[70%] h-10 uppercase text-sm">Meet The Team</button>
        </div>  
        </div>
